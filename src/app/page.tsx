...
export default function LandingPage() {
  ...
  const [showButton, setShowButton] = useState(false);
    ...
    const testimonials = [
      {
        quote: "The classes here are exceptionally conducive to learning, with instructors who elucidate complex concepts with remarkable clarity and precision. Beyond the academic rigor, the mentorship at Nyeras has been instrumental in my professional development, providing unwavering support and guidance toward achieving my career aspirations.",
        author: "Alex Johnson",
      ...
      {
        quote: "The data analytics course I took, was an excellent investment in my skillset. The curriculum was comprehensive, covering both theoretical concepts and practical applications. The instructors were knowledgeable and supportive, guiding us through complex topics with clarity and patience. The hands-on projects allowed me to apply what I learned in real-world scenarios, boosting my confidence in using these tools professionally.",
        author: "Samantha Lee",
